...
<% pageContext.setAttribute("pageTitle", "Mi Carrito de Compras"); %>
...
<jsp:include page="header.jsp" />
    ...
    <div class="container mt-4">
        ...
        <table class="table align-middle">
            ...
            <tfoot>
                <tr>
                    ...
                    <td colspan="2"><strong>S/ <%= String.format("%.2f", total) %></strong></td>
                </tr>
            </tfoot>
        </table>
        ...
        <div class="d-flex justify-content-between mt-4">
             ...
             <button type="button" class="btn btn-success" onclick="return confirm('Pago realizado con éxito')">Proceder al Pago</button>
        </div>
